...
/*   Updated: 2023/12/12 20:02:47 by ecullier         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void check_perpendicularity(t_player *player)
{
    ...
    {
        printf("Erreur : Les vecteurs de direction et de plan ne sont plus perpendiculaires.\n");
        exit(EXIT_FAILURE);
    }
}
